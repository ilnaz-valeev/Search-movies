    ...
    return (
        <main className="home-page">
            ...
            <nav className="bottom-navigation">
                <button className="bottom-navigation__button bottom-navigation__button--home">  </button>
                <button className="bottom-navigation__button bottom-navigation__button--discover">ico</button>
                <button className="bottom-navigation__button bottom-navigation__button--movies">ico</button>
                <button className="bottom-navigation__button bottom-navigation__button--profile">ico</button>
            </nav>
        </main>
    );
};
